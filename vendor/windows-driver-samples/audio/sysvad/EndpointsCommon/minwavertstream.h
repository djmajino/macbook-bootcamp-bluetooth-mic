...
#ifdef BLUETOOTH_MIC_MAC_HCI_AUDIO_BRIDGE
    UART_H4_AUDIO_INTERFACE     m_HciAudio;
    PFILE_OBJECT                m_HciAudioFileObject;
    BOOLEAN                     m_HciAudioInterfaceAcquired;
    BOOLEAN                     m_HciAudioStreamOpen;
#endif
...
#ifdef BLUETOOTH_MIC_MAC_HCI_AUDIO_BRIDGE
    BOOLEAN IsHciAudioBridgeStream();
    VOID AcquireHciAudioInterface();
    VOID ReleaseHciAudioInterface();
    NTSTATUS OpenHciAudioStream();
    VOID CompleteHciAudioStreamOpen();
    VOID CloseHciAudioStream();
#endif
